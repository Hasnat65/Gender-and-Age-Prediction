...
################################### main ###########################
    ...
    file = open('picture/gender_data','r')
    ...
    trainX = image_list[0:length*10//10]
    trainY = gender_list_cato[0:length*10//10]
    trainX = np.array(trainX)
    trainY = np.array(trainY)
    validX = image_list[length*8//10:length*9//10]
    validY = gender_list_cato[length*8//10:length*9//10]
    validX = np.array(validX)
    validY = np.array(validY)
    testX = image_list[length*9//10:-1]
    testY = gender_list_cato[length*9//10:-1]
